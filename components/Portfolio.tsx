...
const spellbindScroll: RailItem[] = [
  ...
  { media: { type: 'photo', src: '/images/IMG_7720.JPG', alt: 'Spellbind — exhibition view' }, w: '44vw', idx: '11', cap: '' },
  { media: { type: 'photo', src: '/images/IMG_7538.JPG', alt: 'Spellbind — thread detail' }, w: '44vw', idx: '12', cap: '' },
  { media: { type: 'photo', src: '/images/IMG_7245.JPG', alt: 'Spellbind — exhibition view' }, w: '44vw', idx: '13', cap: '' },
]
...
const kingsCrossPortraits: RailItem[] = [
  { media: { type: 'photo' as const, src: '/images/DSC_1580.JPG', alt: 'King’s Cross Portraits 1', color: true }, w: '23vw', idx: '1', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1583.JPG', alt: 'King’s Cross Portraits 2', color: true }, w: '23vw', idx: '2', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1588.JPG', alt: 'King’s Cross Portraits 3', color: true }, w: '23vw', idx: '3', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1577.JPG', alt: 'King’s Cross Portraits 4', color: true }, w: '23vw', idx: '4', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1585.JPG', alt: 'King’s Cross Portraits 5', color: true }, w: '23vw', idx: '5', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1594.JPG', alt: 'King’s Cross Portraits 6', color: true }, w: '23vw', idx: '6', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1682.JPG', alt: 'King’s Cross Portraits 7', color: true }, w: '23vw', idx: '7', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_0307.JPG', alt: 'King’s Cross Portraits 8', color: true }, w: '23vw', idx: '8', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_1579.JPG', alt: 'King’s Cross Portraits 9', color: true }, w: '23vw', idx: '9', cap: '' },
  { media: { type: 'photo' as const, src: '/images/DSC_0320.JPG', alt: 'King’s Cross Portraits 10', color: true }, w: '23vw', idx: '10', cap: '' },
]
  ...
  },
  {
    ...
    sections: [
      ...
      // while the maquette images remain as their own smaller scroll.
      {
        ...
        label: '01 — Scroll',
        items: [
         { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-3.jpg', alt: 'Tracing Light — scroll 3' }, w: '42vw', idx: '1', cap: '' },
  { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-4.jpg', alt: 'Tracing Light — scroll 4' }, w: '42vw', idx: '2', cap: '' },
  { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-5.jpg', alt: 'Tracing Light — scroll 5' }, w: '42vw', idx: '3', cap: '' },
  { media: { type: 'photo' as const, src: '/images/kings-cross-scroll-2.jpg', alt: 'Tracing Light — scroll 4' }, w: '42vw', idx: '4', cap: '' },
  { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-7.jpg', alt: 'Tracing Light — scroll 7' }, w: '42vw', idx: '5', cap: '' },
  { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-1.jpg', alt: 'Tracing Light — scroll 1' }, w: '42vw', idx: '6', cap: '' },
  { media: { type: 'photo' as const, src: '/images/IMG_0302.JPG', alt: 'Tracing Light — rain reflection' }, w: '42vw', idx: '7', cap: '' },
  { media: { type: 'photo' as const, src: '/images/kings-cross-scroll-3.jpg', alt: 'Tracing Light — scroll 8' }, w: '42vw', idx: '8', cap: '' },
  { media: { type: 'photo' as const, src: '/images/tracing-light-scroll-2.jpg', alt: 'Tracing Light — scroll 2' }, w: '42vw', idx: '9', cap: '' },
